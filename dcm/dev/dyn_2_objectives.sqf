...
dyn2_town_assault = {
    ...
    _playerStart = [[[_locPos, 3000]], [[_locPos, 2000], "water"]] call BIS_fnc_randomPos;
	...
	[_locPos, _playerStart, dyn2_strength + ([0, 2] call BIS_fnc_randomInt)] call dyn2_SIDE_mission_spawner;
	...
	{
	  	[_x, 26 - dyn2_strength, 5, 2, 350] spawn dyn2_cvivilian_presence;
	} forEach _civilTowns;
	[_loc, 25 - (dyn2_strength * 2), 8, 6, 500] spawn dyn2_cvivilian_presence;
...
dyn2_small_town_assault = {
	...
	[_locPos, _playerStart, dyn2_strength + ([1, 3] call BIS_fnc_randomInt)] call dyn2_SIDE_mission_spawner;
	// Ambiance
	_civilTowns = nearestLocations [_locPos getpos [500, _defDir], ["NameCity", "NameVillage", "NameCityCapital"], 1000];
	_civilTowns = _civilTowns - [_loc];
...
dyn2_air_field_assault = {
	...
	// Sidemission
	[_locPos, _playerStart, dyn2_strength + ([0, 2] call BIS_fnc_randomInt), ["destroy_vic"]] call dyn2_SIDE_mission_spawner;
