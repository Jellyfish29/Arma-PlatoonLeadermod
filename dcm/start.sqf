...
dyn2_opfor_fation = _this select 0;
dyn2_strength = _this select 1;
dyn2_weather = _this select 2;
dyn2_Civilians = _this select 3;
dyn2_PlacePlayer = _this select 4;
...
execVM "Plmod\dcm\dyn_2_setup.sqf";
execVM "Plmod\dcm\dyn_2_paint.sqf";
execVM "Plmod\dcm\dyn_2_util.sqf";
execVM "Plmod\dcm\dyn_2_spawn.sqf";
execVM "Plmod\dcm\dyn_2_ambiance.sqf";
execVM "Plmod\dcm\dyn_2_secondary_objectives.sqf";
execVM "Plmod\dcm\dyn_2_opfor_missions.sqf";
execVM "Plmod\dcm\dyn_2_objectives.sqf";
