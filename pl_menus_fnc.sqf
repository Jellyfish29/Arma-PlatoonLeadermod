...
pl_show_cas_menu = {
    ...
    pl_cas_menu = [
        ['CAS',true],
        ['Gun Run', [2], '', -5, [['expression', '[1] spawn pl_cas']], '1', '%1'],
        ['Attack Run', [3], '', -5, [['expression', '[2] spawn pl_cas']], '1', '%2'],
        ['Cluster Bomb Strike', [4], '', -5, [['expression', '[3] spawn pl_cas']], '1', '%3'],
        ['JDAM Strike', [5], '', -5, [['expression', '[4] spawn pl_cas']], '1', '%4']
    ];", pl_gun_enabled, pl_gun_rocket_enabled, pl_cluster_enabled, pl_jdam_enabled];
