...
//--- Automatic group assigning
if (isnull(hcleader group player)) then {player HCsetgroup [group player,""]};
_addAllGroups = _logic getvariable "addAllGroups";
if (_addAllGroups) then {
